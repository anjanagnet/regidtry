            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Donor Requests</h4>
                                <p class="category">Accept / Reject New Donor Requests</p>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped">
                                    <thead>
                                    	...
                                    	<th>Telephone</th>
                                        <th>Relation Name</th>
                                        <th>Relation Telephone</th>
                                        <th>Accept/Reject</th>
                                    </thead>
                                    <tbody>
                                         
                                        <?php for($i=0; $i<count($donorReq); $i++){ ?>
                                        <tr>
                                            <td><?php echo $donorReq[$i]->id?></td>
                                            <td><?php echo $donorReq[$i]->fName?></td>
                                            <td><?php echo $donorReq[$i]->lName?></td>
                                            <td><?php echo $donorReq[$i]->nic?></td>
                                            <td><?php echo $donorReq[$i]->telephone_1?></td>
                                            <td><?php echo $donorReq[$i]->CR_fName?></td>
                                            <td><?php echo $donorReq[$i]->CR_telephone_1?></td>
                                            <td><a class="btn btn-primary btn-sm" href="donors/acceptDonor/<?php echo $donorReq[$i]->id?>" role="button">Accept</a>
                                                <!--<a class="btn btn-primary btn-sm" href="users/rejectUser/<?php echo $userReq[$i] ;?>" role="button">Reject</a>-->
                                            </td>
                                        </tr>    
                                        <?php } ?>
