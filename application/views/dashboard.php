                        ...
                        <div class="card">
                            <div class="content">
                                ...
                                <div class="footer">
                                    <hr />
                                    <div class="stats">
                                        <a href="request"><i class="ti-reload"></i>Click to Accept/Reject</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="content">
                                ...
                                <div class="footer">
                                    <hr />
                                    <div class="stats">
                                        <a href="newDonor"<i class="ti-calendar"></i> Click to Register</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="content">
                                ...
                                <div class="footer">
                                    <hr />
                                    <div class="stats">
                                        <a href="donorRequests"<i class="ti-calendar"></i> Click to Accept</a>
                                    </div>
                                </div>
                            </div>
                        </div>
