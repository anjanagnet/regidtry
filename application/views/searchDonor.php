...
<div class="wrapper">
                    ...
                    <div class="col-lg-6 col-md-7">
                        ...
                        <div class="card" id='nameForm'>
                            ...
                            <div class="content">
                                ...
                                <form action="donors/searchByName" method="post" id="searchUserForm">
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <div class="form-group">
                                                <label for="fname">Fist Name</label>
                                                <input type="text" class="form-control border-input" id="fname" name="fname" placeholder="First name">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control border-input" id="lname" name="lname" placeholder="Last name">
                                            </div>
                                        </div>
                                    </div>    
                                    ...
                                    <div class="text-right">
                                        ...
                                        <input id="button" type="submit" onclick="addnumber()" value="Search user"/>
                                    </div>
    ...
    <!--Validations-->
        ...
        <script src="../custom/js/searchName.js"></script>
