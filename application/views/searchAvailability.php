...
<div class="wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-7">
                        ...
                        <div class="card" id='nameForm'>
                            <div class="header">
                                <h4 class="title">Search Availability</h4>
                            </div>
                            
                            <div class="content">
                                
                                <form action="donors/searchByAvailability" method="post" id="searchAvailabilityForm">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group border-input">
                                                ...
                                                <select class="form-control border-input" id="status" name="status" >
                                                    ...
                                                    <option value="5" >Pending Acceptance</option>
                                                </select> 
                                            </div>
                                        </div>
                                    </div>
    ...
    <!--Validations-->
        ...
        <script src="../custom/js/searchAvailability.js"></script>
